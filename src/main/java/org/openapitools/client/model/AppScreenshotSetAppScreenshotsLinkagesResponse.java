 ...
 */
@JsonPropertyOrder({
  AppScreenshotSetAppScreenshotsLinkagesResponse.JSON_PROPERTY_DATA,
...
public class AppScreenshotSetAppScreenshotsLinkagesResponse {
  ...
  public AppScreenshotSetAppScreenshotsLinkagesResponse data(List<AppScreenshotSetRelationshipsAppScreenshotsDataInner> data) {
    this.data = data;
    return this;
  }

  public AppScreenshotSetAppScreenshotsLinkagesResponse addDataItem(AppScreenshotSetRelationshipsAppScreenshotsDataInner dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this AppScreenshotSetAppScreenshotsLinkagesResponse object is equal to o.
   */
  @Override
