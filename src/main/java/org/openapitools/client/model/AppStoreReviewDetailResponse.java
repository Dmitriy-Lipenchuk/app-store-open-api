...
public class AppStoreReviewDetailResponse {
  ...
  **/
  ...
  public AppStoreReviewDetailResponse included(List<AppStoreReviewDetailResponseIncludedInner> included) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INCLUDED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(List<AppStoreReviewDetailResponseIncludedInner> included) {
    this.included = included;
  }
