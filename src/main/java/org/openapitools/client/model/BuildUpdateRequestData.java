 ...
 */
@JsonPropertyOrder({
  BuildUpdateRequestData.JSON_PROPERTY_TYPE,
  BuildUpdateRequestData.JSON_PROPERTY_ID,
  BuildUpdateRequestData.JSON_PROPERTY_ATTRIBUTES,
  BuildUpdateRequestData.JSON_PROPERTY_RELATIONSHIPS
})
@JsonTypeName("BuildUpdateRequest_data")
...
public class BuildUpdateRequestData {
  ...
  **/
  ...
  /**
   * Return true if this BuildUpdateRequest_data object is equal to o.
   */
  @Override
