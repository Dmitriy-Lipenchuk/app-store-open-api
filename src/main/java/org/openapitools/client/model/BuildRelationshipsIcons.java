...
import org.openapitools.client.model.BuildRelationshipsIconsDataInner;
 ...
 */
@JsonPropertyOrder({
  BuildRelationshipsIcons.JSON_PROPERTY_LINKS,
  BuildRelationshipsIcons.JSON_PROPERTY_META,
  BuildRelationshipsIcons.JSON_PROPERTY_DATA
})
@JsonTypeName("Build_relationships_icons")
...
public class BuildRelationshipsIcons {
  ...
  private List<BuildRelationshipsIconsDataInner> data = new ArrayList<>();

  public BuildRelationshipsIcons() { 
  }

  public BuildRelationshipsIcons links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public BuildRelationshipsIcons data(List<BuildRelationshipsIconsDataInner> data) {
    this.data = data;
    return this;
  }

  public BuildRelationshipsIcons addDataItem(BuildRelationshipsIconsDataInner dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<BuildRelationshipsIconsDataInner> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<BuildRelationshipsIconsDataInner> data) {
    this.data = data;
  }


  /**
   * Return true if this Build_relationships_icons object is equal to o.
   */
  @Override
