 ...
 */
@JsonPropertyOrder({
  AppRelationshipsPreReleaseVersions.JSON_PROPERTY_LINKS,
  AppRelationshipsPreReleaseVersions.JSON_PROPERTY_META,
  AppRelationshipsPreReleaseVersions.JSON_PROPERTY_DATA
})
...
public class AppRelationshipsPreReleaseVersions {
  ...
  private List<AppRelationshipsPreReleaseVersionsDataInner> data = new ArrayList<>();

  public AppRelationshipsPreReleaseVersions() { 
  }

  public AppRelationshipsPreReleaseVersions links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public AppRelationshipsPreReleaseVersions data(List<AppRelationshipsPreReleaseVersionsDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public List<AppRelationshipsPreReleaseVersionsDataInner> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<AppRelationshipsPreReleaseVersionsDataInner> data) {
    this.data = data;
  }


  /**
   * Return true if this App_relationships_preReleaseVersions object is equal to o.
   */
  @Override
