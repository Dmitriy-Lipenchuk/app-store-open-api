 ...
 */
@JsonPropertyOrder({
  AppRelationshipsBetaAppReviewDetail.JSON_PROPERTY_LINKS,
  AppRelationshipsBetaAppReviewDetail.JSON_PROPERTY_DATA
})
@JsonTypeName("App_relationships_betaAppReviewDetail")
...
public class AppRelationshipsBetaAppReviewDetail {
  ...
  public AppRelationshipsBetaAppReviewDetail links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this App_relationships_betaAppReviewDetail object is equal to o.
   */
  @Override
