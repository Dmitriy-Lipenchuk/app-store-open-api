 ...
 */
@JsonPropertyOrder({
  BetaAppReviewSubmissionCreateRequestDataRelationshipsBuild.JSON_PROPERTY_DATA
})
...
public class BetaAppReviewSubmissionCreateRequestDataRelationshipsBuild {
  ...
  public BetaAppReviewSubmissionCreateRequestDataRelationshipsBuild data(AppEncryptionDeclarationRelationshipsBuildsDataInner data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this BetaAppReviewSubmissionCreateRequest_data_relationships_build object is equal to o.
   */
  @Override
