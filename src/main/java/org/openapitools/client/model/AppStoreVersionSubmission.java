...
@Deprecated
@JsonPropertyOrder({
  AppStoreVersionSubmission.JSON_PROPERTY_TYPE,
  AppStoreVersionSubmission.JSON_PROPERTY_ID,
  AppStoreVersionSubmission.JSON_PROPERTY_RELATIONSHIPS,
  AppStoreVersionSubmission.JSON_PROPERTY_LINKS
})
...
public class AppStoreVersionSubmission {
  ...
  **/
  ...
  /**
   * Return true if this AppStoreVersionSubmission object is equal to o.
   */
  @Override
