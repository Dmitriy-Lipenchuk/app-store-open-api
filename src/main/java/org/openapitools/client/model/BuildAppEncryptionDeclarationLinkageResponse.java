 ...
 */
@JsonPropertyOrder({
  BuildAppEncryptionDeclarationLinkageResponse.JSON_PROPERTY_DATA,
...
public class BuildAppEncryptionDeclarationLinkageResponse {
  ...
  public BuildAppEncryptionDeclarationLinkageResponse data(AppEncryptionDeclarationDocumentCreateRequestDataRelationshipsAppEncryptionDeclarationData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this BuildAppEncryptionDeclarationLinkageResponse object is equal to o.
   */
  @Override
