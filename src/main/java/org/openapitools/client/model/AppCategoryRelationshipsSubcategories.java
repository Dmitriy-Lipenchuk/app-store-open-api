...
import org.openapitools.client.model.AppCategoryRelationshipsSubcategoriesDataInner;
 ...
 */
@JsonPropertyOrder({
  AppCategoryRelationshipsSubcategories.JSON_PROPERTY_LINKS,
...
public class AppCategoryRelationshipsSubcategories {
  ...
  private List<AppCategoryRelationshipsSubcategoriesDataInner> data = new ArrayList<>();

  public AppCategoryRelationshipsSubcategories() { 
  }

  public AppCategoryRelationshipsSubcategories links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public AppCategoryRelationshipsSubcategories data(List<AppCategoryRelationshipsSubcategoriesDataInner> data) {
    this.data = data;
    return this;
  }

  public AppCategoryRelationshipsSubcategories addDataItem(AppCategoryRelationshipsSubcategoriesDataInner dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<AppCategoryRelationshipsSubcategoriesDataInner> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(List<AppCategoryRelationshipsSubcategoriesDataInner> data) {
    this.data = data;
  }


  /**
   * Return true if this AppCategory_relationships_subcategories object is equal to o.
   */
  @Override
