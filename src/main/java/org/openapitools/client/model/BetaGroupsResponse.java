 ...
 */
@JsonPropertyOrder({
  BetaGroupsResponse.JSON_PROPERTY_DATA,
  BetaGroupsResponse.JSON_PROPERTY_INCLUDED,
  BetaGroupsResponse.JSON_PROPERTY_LINKS,
  BetaGroupsResponse.JSON_PROPERTY_META
})
...
public class BetaGroupsResponse {
  ...
  private List<BetaGroupsResponseIncludedInner> included = new ArrayList<>();
  ...
  **/
  ...
  public BetaGroupsResponse included(List<BetaGroupsResponseIncludedInner> included) {
    this.included = included;
    return this;
  }

  public BetaGroupsResponse addIncludedItem(BetaGroupsResponseIncludedInner includedItem) {
  ...
  **/
  ...
  public List<BetaGroupsResponseIncludedInner> getIncluded() {
    return included;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INCLUDED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncluded(List<BetaGroupsResponseIncludedInner> included) {
    this.included = included;
  }
  ...
  **/
  ...
  /**
   * Return true if this BetaGroupsResponse object is equal to o.
   */
  @Override
