 ...
 */
@JsonPropertyOrder({
  BuildBetaDetailResponse.JSON_PROPERTY_DATA,
  BuildBetaDetailResponse.JSON_PROPERTY_INCLUDED,
...
public class BuildBetaDetailResponse {
  ...
  **/
  ...
  /**
   * Return true if this BuildBetaDetailResponse object is equal to o.
   */
  @Override
