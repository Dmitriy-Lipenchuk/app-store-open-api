 ...
 */
@JsonPropertyOrder({
  AppPreviewSetRelationshipsAppStoreVersionLocalization.JSON_PROPERTY_LINKS,
...
public class AppPreviewSetRelationshipsAppStoreVersionLocalization {
  ...
  public AppPreviewSetRelationshipsAppStoreVersionLocalization links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
