 ...
 */
@JsonPropertyOrder({
  AppPreOrderAttributes.JSON_PROPERTY_PRE_ORDER_AVAILABLE_DATE,
...
public class AppPreOrderAttributes {
  ...
  **/
  ...
  /**
   * Return true if this AppPreOrder_attributes object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(preOrderAvailableDate, appReleaseDate);
  }
