 ...
 */
@JsonPropertyOrder({
  UserInvitationRelationships.JSON_PROPERTY_VISIBLE_APPS
})
@JsonTypeName("UserInvitation_relationships")
...
public class UserInvitationRelationships {
  ...
  **/
  ...
  /**
   * Return true if this UserInvitation_relationships object is equal to o.
   */
  @Override
