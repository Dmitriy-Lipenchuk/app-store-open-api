 ...
 */
@JsonPropertyOrder({
  AppInfoLocalizationRelationshipsAppInfo.JSON_PROPERTY_LINKS,
  AppInfoLocalizationRelationshipsAppInfo.JSON_PROPERTY_DATA
})
@JsonTypeName("AppInfoLocalization_relationships_appInfo")
...
public class AppInfoLocalizationRelationshipsAppInfo {
  ...
  public AppInfoLocalizationRelationshipsAppInfo links(AlternativeDistributionPackageVersionRelationshipsVariantsLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this AppInfoLocalization_relationships_appInfo object is equal to o.
   */
  @Override
