 ...
 */
@JsonPropertyOrder({
  BuildBetaDetailsResponse.JSON_PROPERTY_DATA,
  BuildBetaDetailsResponse.JSON_PROPERTY_INCLUDED,
  BuildBetaDetailsResponse.JSON_PROPERTY_LINKS,
  BuildBetaDetailsResponse.JSON_PROPERTY_META
})
...
public class BuildBetaDetailsResponse {
  ...
  **/
  ...
  /**
   * Return true if this BuildBetaDetailsResponse object is equal to o.
   */
  @Override
