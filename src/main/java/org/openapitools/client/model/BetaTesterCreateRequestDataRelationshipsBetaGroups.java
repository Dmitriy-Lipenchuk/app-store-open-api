 ...
 */
@JsonPropertyOrder({
  BetaTesterCreateRequestDataRelationshipsBetaGroups.JSON_PROPERTY_DATA
})
...
public class BetaTesterCreateRequestDataRelationshipsBetaGroups {
  ...
  public BetaTesterCreateRequestDataRelationshipsBetaGroups data(List<AppRelationshipsBetaGroupsDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this BetaTesterCreateRequest_data_relationships_betaGroups object is equal to o.
   */
  @Override
