 ...
 */
@JsonPropertyOrder({
  BetaGroupBetaTestersLinkagesResponse.JSON_PROPERTY_DATA,
...
public class BetaGroupBetaTestersLinkagesResponse {
  ...
  public BetaGroupBetaTestersLinkagesResponse data(List<BetaGroupRelationshipsBetaTestersDataInner> data) {
    this.data = data;
    return this;
  }

  public BetaGroupBetaTestersLinkagesResponse addDataItem(BetaGroupRelationshipsBetaTestersDataInner dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  /**
   * Return true if this BetaGroupBetaTestersLinkagesResponse object is equal to o.
   */
  @Override
