...
@Deprecated
@JsonPropertyOrder({
  GameCenterEnabledVersionCompatibleVersionsLinkagesResponse.JSON_PROPERTY_DATA,
...
public class GameCenterEnabledVersionCompatibleVersionsLinkagesResponse {
  ...
  public GameCenterEnabledVersionCompatibleVersionsLinkagesResponse data(List<AppRelationshipsGameCenterEnabledVersionsDataInner> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this GameCenterEnabledVersionCompatibleVersionsLinkagesResponse object is equal to o.
   */
  @Override
